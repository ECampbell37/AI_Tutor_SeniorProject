...
export default function Home() {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-blue-200 via-blue-100 to-cyan-100 text-gray-900 overflow-x-hidden">
      ...
      {/* HERO SECTION */}
      <section className="min-h-[80vh] flex flex-col justify-center items-center text-center px-6 py-20 bg-gradient-to-br from-blue-200 via-blue-100 to-cyan-100 animate-fadeInUp">
        <div className="max-w-3xl bg-white bg-opacity-90 p-10 rounded-2xl shadow-xl">
      ...
      <section className="py-10 bg-gradient-to-br from-blue-200 via-blue-100 to-cyan-100 border-y border-gray-200 animate-fadeInUp">
        <div className="overflow-hidden">
          <div className="scrolling-images flex space-x-4 px-4">
      ...
      <main className="max-w-5xl mx-auto px-6 py-16 space-y-16">
        ...
        <section className="bg-blue-50 rounded-2xl py-16 px-6 shadow-md text-center animate-fadeInUp">
          <h2 className="text-3xl font-bold text-gray-800 mb-4">💬 Free Chat</h2>
          ...
          <Link href="/freeChat" className='hover:no-underline'>
            <button className="bg-gradient-to-r from-green-400 via-teal-400 to-cyan-400 text-white font-semibold py-3 px-8 rounded-full flex items-center justify-center mx-auto shadow-md hover:shadow-lg hover:scale-105 transition-transform duration-300">
              Try Free Chat
        ...
        {/* ABOUT SECTION */}
        <section className="bg-blue-50 bg-opacity-90 rounded-2xl py-16 px-6 animate-fadeInUp border-t border-gray-100">
          <div className="max-w-4xl mx-auto text-center">
            <h2 className="text-3xl font-extrabold text-gray-900 mb-4">🤖 About This Project</h2>
            <p className="text-lg text-gray-700 mb-8">
            ...
            <Link href="/about" className="hover:no-underline">
              <button className="bg-gradient-to-r from-rose-400 via-pink-500 to-rose-500 text-white font-semibold py-3 px-8 rounded-full flex items-center justify-center shadow-md hover:shadow-lg hover:scale-105 transition-transform duration-300 mx-auto">
                Visit About Page
                <ArrowRight className="ml-2 h-5 w-5" />
              </button>
            </Link>
